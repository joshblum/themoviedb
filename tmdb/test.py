...
class TmdbCoreTest(unittest.TestCase):
    ...
    def test_getJSON(self):
        self.assertEqual(
            self.core.getJSON("http://httpbin.org/get?m=hello")["args"]["m"], "hello")
...
class TmdbMovieTest(unittest.TestCase):
    ...
    def test_get_collection_name(self):
        self.assertEqual(
            self.movie.get_collection_name(), "The Avengers Collection")

    def test_get_collection_backdrop(self):
        self.assertEqual(self.movie.get_collection_backdrop(),
                         "http://cf2.imgobject.com/t/p/original/zuW6fOiusv4X9nnW3paHGfXcSll.jpg")

    def test_get_collection_poster(self):
        self.assertEqual(self.movie.get_collection_poster(),
                         "http://cf2.imgobject.com/t/p/original/fMSxlk2zPpcXBn4R3TK3uqYjOpa.jpg")

    def test_get_budget(self):
        self.assertEqual(self.movie.get_budget(), 220000000)

    def test_get_genres(self):
        self.assertEqual(self.movie.get_genres(), [
                         {'name': 'Action', 'id': 28}, {'name': 'Thriller', 'id': 53}])

    def test_get_homepage(self):
        self.assertEqual(
            self.movie.get_homepage(), "http://marvel.com/avengers_movie/")

    def test_get_imdb_id(self):
        self.assertEqual(self.movie.get_imdb_id(), "tt0848228")

    def test_get_overview(self):
        self.assertEqual(self.movie.get_overview(),
    ...
    def test_get_production_companies(self):
        self.assertEqual(self.movie.get_production_companies(), {
                         'id': 3036, 'name': 'Walt Disney Studios Motion Pictures'})

    def test_get_production_countries(self):
        self.assertEqual(self.movie.get_productions_countries(), [
    ...
    def test_get_spoken_languages(self):
        self.assertEqual(self.movie.get_spoken_languages(), [
    ...
    def test_get_backdrop(self):
        self.assertEqual(self.movie.get_backdrop(),
                         "http://cf2.imgobject.com/t/p/original/hbn46fQaRmlpBuUrEiFqv0GDL6Y.jpg")
    ...
    def test_get_poster(self):
        self.assertEqual(self.movie.get_poster(),
                         "http://cf2.imgobject.com/t/p/original/cezWGskPY5x7GaglTTRN4Fugfb8.jpg")
